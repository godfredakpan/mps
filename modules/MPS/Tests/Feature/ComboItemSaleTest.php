...
class ComboItemSaleTest extends MPSTestCase
{
    ...
    public function testMPSComboDealsAreWorkingFine()
    {
        ...
        // dd($this->user->roles->toArray(), Sale::where('id', $sale->id)->count(), $sale->user_id, $this->user->id, $sale->id, $response->json()['message']);
        $response->assertOk();
        // update
        $sale = $sale->refresh();
