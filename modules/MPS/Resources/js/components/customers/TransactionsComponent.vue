...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: this.$tc('customer'), sortable: false, key: 'customer', render: this.renderCustomer },
  ...
  created() {
    ...
    this.url = `app/customers/transactions/${this.$route.params.id}/table`;
    this.$http
      .get(`app/customers/transactions/${this.$route.params.id}`, { params: { ...this.reportForm, date: '' } })
      .then(res => {
  ...
  methods: {
    handleSubmit(form) {
      ...
      this.url = `app/customers/transactions/${this.$route.params.id}/table?${this.queryString(this.reportForm)}`;
      this.refresh++;
      this.$http
        .get(`app/customers/transactions/${this.$route.params.id}`, { params: { ...this.reportForm, date: '' } })
        .then(res => {
