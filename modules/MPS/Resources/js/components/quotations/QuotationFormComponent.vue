<template>
  <div>
    <Card :dis-hover="true">
      <p slot="title">{{ form.id ? $t('edit') : $t('add') }} {{ $tc('quotation') }}</p>
      <router-link to="/quotations" slot="extra">
        <Icon type="ios-grid-outline" />
        {{ $t('list') }} {{ $tc('quotation', 2) }}
      </router-link>
      <div>
        <Form ref="quotation" :model="form" :rules="rules" :label-width="150" class="form-responsive">
          <Row :gutter="16">
            <Col :sm="24" :md="24" :lg="24">
              ...
              <FormItem>
                <Button type="primary" :loading="saving" :disabled="saving" @click="handleSubmit('quotations')">
                ...
                <Button
                  ...
                  @click="handleSubmit('quotations', true)"
                >
...
export default {
  ...
  mixins: [Order('quotation'), OrderHelpers('price', 'form', false)],
};
</script>
