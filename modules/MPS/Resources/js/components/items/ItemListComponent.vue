<template>
  <div>
    <Card :dis-hover="true">
      <p slot="title">{{ $tc('item', 2) }}</p>
      <router-link to="/items/add" slot="extra">
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: this.$tc('serial', 2), sortable: true, key: 'has_serials', minWidth: 90, render: this.renderHasSerials },
        { title: this.$tc('variant', 2), sortable: true, key: 'has_variants', minWidth: 90, render: this.renderHasVariants },
        { title: this.$t('min_price'), sortable: true, key: 'min_price', minWidth: 120, render: this.renderMinPrice },
        { title: this.$t('max_price'), sortable: true, key: 'max_price', minWidth: 120, render: this.renderMaxPrice },
  ...
  methods: {
    ...
    renderHasSerials(h, params) {
      return this.renderBoolean(h, params, 'has_serials');
    },
    renderHasVariants(h, params) {
      return this.renderBoolean(h, params, 'has_variants');
    },
